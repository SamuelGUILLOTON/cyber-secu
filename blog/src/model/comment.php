...
class CommentRepository
{
    ...
    {
        $sql = "INSERT INTO comments(post_id, author, comment, comment_date) VALUES ($post, $author, $comment, NOW())";
        
        // Execute the query
        $affectedLines = $this->connection->getConnection()->exec($sql);
    ...
    {   
        ...
        $sql = "UPDATE comments SET author = $author, comment = $comment WHERE id = $identifier";
